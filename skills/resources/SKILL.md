...
OAuth resources are managed through the Orvanta UI and marked:
...
OAuth tokens are automatically refreshed by Orvanta.
...
```bash
# List resources
orvanta resource list

# List resource types with schemas
orvanta resource-type list --schema

# Get specific resource type schema
orvanta resource-type get postgresql
